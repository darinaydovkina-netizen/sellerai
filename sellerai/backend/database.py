    ...
    async with async_session() as session:
        ...
        if not result.scalars().first():
            session.add_all([
                ...
                Tariff(name="starter", generations_per_month=30, price=199),
                Tariff(name="business", generations_per_month=100, price=499),
                Tariff(name="pro", generations_per_month=-1, price=990),
            ])
